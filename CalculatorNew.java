...
package com.mycompany.calculatornew;
...
public class CalculatorNew {
    ...
    public static void main(String[] args) {
        //EventQueue.invokeLater posts an event (new Runnable) at the end of swing event list
        //and is processed after all previous GUI events are processed
